...
public class KeyValueAccessMetaStore implements DelegateStore {
	...
	public JsonElement store_readAttributesJson(
		...
		try (final VolatileReadData readData = kva.createReadData(attributesPath);) {
			...
			return null;
		} catch (final UncheckedIOException | N5Exception.N5IOException e) {
			throw new N5Exception.N5IOException("Failed to read attributes from " + attributesPath, e);
		}
	}
	...
	public void store_writeAttributesJson(
		...
		} catch (UncheckedIOException | N5Exception.N5IOException e) {
	...
	@Override
	public void store_createDirectories(N5Path.N5GroupPath group) throws N5Exception.N5IOException {
