...
public interface ContainerDialect {
	...
	/**
	 * Get the {@link HierarchyStore} of this {@code ContainerDialect}.
	 * <p>
	 * This is used to implement low-level hierarchy and metadata IO: creating,
	 * deleting, and listing directories, as well as reading and writing
	 * json files.
	 *
	 * @return the {@code HierarchyStore}
	 */
	HierarchyStore getHierarchyStore();

	/**
	 * Get the {@link Gson} instance of this {@code ContainerDialect}.
	 * <p>
	 * This is used for de/serializing attributes and has the all required
	 * adapters for compressions, codecs, etc.
	 *
	 * @return the {@code Gson}
	 */
	Gson getGson();
