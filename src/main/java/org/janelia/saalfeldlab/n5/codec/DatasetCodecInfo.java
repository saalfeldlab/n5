...
public interface DatasetCodecInfo extends CodecInfo {
	 ...
	 * is the type of the source blocks this codec will receive encoding.
	 * <p>
	 ...
	 * behavior depends on the input type should override this.
	 *
	 * @param attributes
	 ...
	 * {@link CastValueCodec}) needs to override it.
	 *
	 * @param dataType
	 *            the data type of the source blocks passed to encode
