...
public class TrackingMetaStore implements DelegateStore {
	...
	@Override
	public JsonElement store_readAttributesJson(final N5Path.N5GroupPath group, final String filename, final Gson gson) throws N5Exception.N5IOException {
		counters.incReadAttr();
		return delegate.store_readAttributesJson(group, filename, gson);
	}

	@Override
	public void store_writeAttributesJson(final N5Path.N5GroupPath group, final String filename, final JsonElement attributes, final Gson gson) throws
	...
	@Override
	public void store_removeAttributesJson(final N5Path.N5GroupPath group, final String filename) throws N5Exception.N5IOException {
